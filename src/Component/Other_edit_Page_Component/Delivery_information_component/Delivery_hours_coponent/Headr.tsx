    ...
    return (
        <View>
            <View style={{ display: 'flex', flexDirection: 'row', width: SCREEN_WIDTH - 20, alignSelf: 'center', marginTop: '5%', justifyContent: 'space-between' }}>
                <View>
                    <TouchableOpacity style={{ alignSelf: 'center' }} onPressOut={()=>navigation.navigate('Delivery_Home')}>
                        <Go width={40} height={40} />
                    </TouchableOpacity>
                </View>
                <View style={{}}>
                    <Text style={{ color: 'rgba(16, 17, 20, 1)', fontSize: 20, textAlign: 'center' }}>Çatdırılma saatları</Text>
                </View>
                <TouchableOpacity>
