        ...
        <View style={{ marginTop: '1%' }}>
            {!fileSelected ? (
                <View style={{ marginTop: '10%' }}>
                    <Text style={{ color: 'rgba(16, 17, 20, 1)', fontWeight: '400', }}>TexPassport avtomobil <Text style={{color:'rgba(16, 17, 20, 1)', fontWeight:'200'}}> 2-ci səhifə </Text></Text>
                ...
                <View>
                    <Text style={{ color: 'rgba(16, 17, 20, 1)', fontWeight: '400', marginVertical:'5%' }}>TexPassport avtomobil <Text style={{color:'rgba(16, 17, 20, 1)', fontWeight:'200'}}> 2-ci səhifə </Text></Text>
...
export default TexPassport_car