...
import Leftd2 from '../../../assets/imge/Register-imge/chevron_left.svg'
...
const Headr = ({ navigation }: any) => {
    ...
    return (
        <View>
            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', width: SCREEN_WIDTH, marginTop: '3%' }} onPress={() => Next1()}>
                <TouchableOpacity style={{ position: 'absolute', alignItems: 'center', marginLeft: '2%', }} onPress={() => Next1()} >
                    <Leftd2 width={50} height={50} />
                </TouchableOpacity>
