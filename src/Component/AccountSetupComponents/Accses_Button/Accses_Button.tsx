import { View, Text, TouchableOpacity, Animated, TouchableHighlightComponent } from 'react-native'
import React, { useState } from 'react'
import { SCREEN_WIDTH } from '../../../Utils/common'
import Phone from '../../../assets/imge/Accountsetup-imge/icon.svg'
const Accses_Button = ({ navigation, setloading }: any) => {
    const Nextlogin = () => {
        navigation.navigate('LoginScreen',  { animation: 'slide_from_right' })
    ...
    return (
        <View>
                <TouchableOpacity style={{ width: SCREEN_WIDTH - 40, alignSelf: 'center', borderWidth: 1, borderColor: '#4078C5', borderRadius: 10, display: 'flex', flexDirection: 'row', justifyContent: 'space-evenly' }} onPressIn={() => Nextlogin()} delayLongPress={10} pressRetentionOffset={500}>
